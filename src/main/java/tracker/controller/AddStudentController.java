...
public class AddStudentController {
    ...
    protected void onAddStudentButtonClick() {
        ...
        String validationError = validateInputs(firstName, lastName, birthDate, studentNumber, educationLevel, averageGradeText);
        ...
        try {
            ...
            tracker.DAO.StudentDAO.insertStudent(newStudent);
